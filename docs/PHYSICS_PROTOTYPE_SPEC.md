...
`Suspension.ts`는 아직 실제 레이캐스트나 Rapier 충돌을 수행하지 않는다. 현재 단계에서는 차량 질량, 정적 축중, 공력 하중, 종·횡가속도를 사용해 각 휠의 수직 하중과 스프링 압축을 계산한다.
...
2. Rapier 차체 강체 및 4개 휠 레이캐스트 접지
3. 실제 휠 운동학·노면 높이·연석 반응
4. 타이어 온도·마모·노면 진화
5. Rapier 충돌과 트랙 리밋
