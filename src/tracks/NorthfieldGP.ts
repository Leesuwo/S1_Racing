...
const NORTHFIELD_RACING_LINE_SEED = [
  ...
  { id: "northfield-heavy-apex", x: 54, z: 30, targetSpeedMps: 42, brakePoint: true },
  { id: "northfield-heavy-exit", x: 69, z: 10, targetSpeedMps: 32, brakePoint: true },
  { id: "northfield-fast-entry", x: 68, z: -13, targetSpeedMps: 34 },
  { id: "northfield-fast-left", x: 55, z: -32, targetSpeedMps: 38 },
  { id: "northfield-fast-right", x: 36, z: -44, targetSpeedMps: 42 },
  { id: "northfield-fast-exit", x: 13, z: -49, targetSpeedMps: 39 },
  { id: "northfield-low-brake", x: -5, z: -45, targetSpeedMps: 28, brakePoint: true },
  { id: "northfield-low-apex", x: -17, z: -32, targetSpeedMps: 20, brakePoint: true },
  ...
  { id: "northfield-medium-apex", x: 19, z: 33, targetSpeedMps: 40 },
  ...
  { id: "northfield-link-apex", x: -79, z: 4, targetSpeedMps: 41 },
  { id: "northfield-link-hairpin", x: -95, z: -14, targetSpeedMps: 28, brakePoint: true },
